...
\HWNum{CS373 - Spring 2012}{0}{Thursday April 26 at 2:00 PM in class (151 Everitt Lab)}
\Title{Problem Set 5}
\MakeTitleHW
...
%~~~~~~~~~~~~~~~~~
    \item \ProblemTtl{Decidable, Recognizable, or Neither?}{Proof}{40}
...
%~~~~~~~~~~~~~~~~~
    \item \ProblemTtl{False Reduction Proof}{Analysis}{10} 
 ...
 \[\mathsf{REGULAR} = \{ \langle M \rangle ~|~ \text{$M$ is a \TM and $L(M)$ is regular} \} \]	
        ...
        \textbf{Proof}: We provide a reduction from $\overline{A_{TM}}$ to \textsf{REGULAR}. Assume there is a \TM $M_R$ that recognizes \textsf{REGULAR}. Then the following \TM recognizes  $\overline{A_{TM}}$:
...
%~~~~~~~~~~~~~~~~~
    \item \ProblemTtl{Read Two and Append Process}{Comprehension}{12}
...
%~~~~~~~~~~~~~~~~~
    \item \ProblemTtl{Covering}{Algorithm}{16}
